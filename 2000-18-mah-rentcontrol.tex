...
\begin{document}
 \layout
% \cleardoublepage
\actlabel[2000: Mah. XVIII]{Maharashtra Act No. XVIII of 2000}
\title[Bombay Rents... (Amendment), 1999]{%Maharashtra Rent Control Act, 1999
%And a Long Title which Replaces the Housing Rent Act 1923
Bombay Rents, Hotel and
Lodging House Rates Control, Bombay Land Requisition and Bombay Government
Premises (Eviction) (Amendment) Act, 1999
}
\actedition{As modified up to \nth{21} May 2013}
\actedyear{2013}
\price{Rs 23}
...
\assent{%
  This Act received the assent of the President on the \nth{8} March 2000; assent
...
comencement.
\item It shall come into force on such date\footnote{ \nth{31} March
    2000, vide, G. N., H \& SAD., No. MEA. 2000/CR-14/Bhanika, dated
    the \nth{30} March 2000, published in Maharashtra Government
...
\item ``standard rent'' in relation to any premises
  ...
  \item where the standard rent or fair rent is not so fixed, then
    ...
    \begin{subclause}
    \item the rent at which the premises were let on the \nth{1} day of
