...
\begin{document}
    ...
    \amendPrologue{%
        \begin{longtable}{llcll}
          ...
          & 29 of 1973 (30-5-1973)\Inote{I1}{Indicates commencement date of the
            Act}\Cnote{C12}{%
          ...
          " " "  & 27 of 1969\Cnote{C23}{%
                   \actref{Mah.}{1969}{27}{27} reads as under
    ...
    \enactingtext{ WHEREAS with a view to providing for the orderly
      ...
      \begin{subsectionlist}
        ...
        \lblitem{3} It shall come into force on%
        such\Inote{I2}{26th
       ...
       *  * * * * *\FnoterefEnd{F13} replaced by this.
   ...
   \lblitem{4} ``bonus'' means payment made in cash or kind out of
      ...
      \lblitem{5} In Payment of Bonus Act, 1965\Mnoteref{M11} a second
      citation.
    \end{subsectionlist} 
    ...
    %Act, 1956\citenote{M1671}{some act} shall not apply to
