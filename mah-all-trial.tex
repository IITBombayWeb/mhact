...
\coveringNoteSlip{%
 ...
 under the authority of the Governor].
    ...
    \assent{First published, after having received the assent of the
      Governor in the “Maharashtra Government Gazette”, on the 7th
      September 2017.}
...
follows}
    ...
    \lblitem{1} This Act may be called the Maharashtra Shops and Establishments (Regulation of Employment and Conditions of Service) Act, 2017.
    \lblitem{2} It extends to the whole of the State of Maharashtra.
    \lblitem{3} The provisions of this Act, except section 7, shall apply to the 
...
7 shall apply to the establishments employing less than ten workers.
    \lblitem{4} It shall come into force on such date as the State Government may by 
notification in the Official Gazette appoint.
       \end{subsectionlist}
    
        %\section{\subs{Definition}{Definitions}} 
        \section{Definitions}
	\subs{Old text}{Replacement text}
        
      \begin{subsectionlist}
    
    \lblitem{1} "Chief Facilitator" means the Chief Facilitator appointed as such 
under section 28 of this Act; 
    \lblitem{2} "day" means the period of twenty-four hours beginning at midnight;
    \lblitem{3} “employer” means a person owning or having ultimate control over the affairs of an estab- 
lishment, and includes,–
      \begin{clause}
    
    \lblitem{a} in the case of a firm or association of individuals, a partner or members of the firm 
or association;
    \lblitem{b} in the case of a company, a director of the company;
    \lblitem{c} in the case of an establishment owned or controlled by the Central Government or a 
...
or the local authority, as the case may be;
    ...
    \lblitem{4} “establishment” means an establishment which carries on, any business, trade, manufacture or any journalistic or printing work, or business of banking, insurance, stocks and 
...
declare to be an establishment for the purposes of this Act;
    ...
    \lblitem{1} Establishments of the Central and State Government;
    \lblitem{2} Establishments pertaining to any kind of educational activities 
...
individual persons or any institutions other than those,---
    ...
    \lblitem{a} affiliated to any university established by law, or
    \lblitem{b} recognised by the Divisional Boards under the Maharashtra 
Secondary and Higher Secondary Education Boards Act, 1965 
    \actref{Mah}{1965}{41}{}
   or
    \lblitem{c} recognised by the Directorate of Education or the 
...
conducting courses recognised by Government) ;
    ...
    \lblitem{1} Notwithstanding anything contained in this Act, the State 
...
shall apply from such date as may be specified in the notification.
    \lblitem{2} On such declaration under sub-section (1), any such establishment 
...
or class of workers or persons.
   ...
   commences its business, the employer of every establishment employing ten or more workers shall submit application online in a prescribed form for registration to the Facilitator of the local area concerned, together with such fees and such self-declaration and self-certified documents as may be prescribed, containing---
    ...
    \lblitem{a} the name of the employer and the manager, if any;
    \lblitem{b} the postal address of the establishment;
    \lblitem{c} such other particulars as may be prescribed :
    \begin{subclause}
      \lblitem{i} foo
      \lblitem{ii} bar
    \end{subclause}
  \end{clause}
       ...
       \end{subsectionlist}
          ...
          \intro{ The Maharashtra Shops and Establishments Act (LXXIX of 1948) is 
...
\begin{tabular}{*{2}{p{0.5\linewidth}}}
&\\
Vidhan Bhavan : & \multicolumn{1}{r}{Dr. ANANT KALSE,}\\
Mumbai, & \multicolumn{1}{r}{Principal Secretary,}\\
Dated the 8th August 2017. & \multicolumn{1}{r}{Maharashtra
